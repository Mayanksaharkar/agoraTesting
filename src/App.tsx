...
const AstrologerCoursePreview = lazy(() => import("./pages/AstrologerCoursePreview"));
...
const AstrologerChangePassword = lazy(() => import("./pages/AstrologerChangePassword"));
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/astrologer/course-preview/:courseId" element={<ProtectedRoute requiredRole="astrologer"><AstrologerCoursePreview /></ProtectedRoute>} />
      ...
      <Route path="/astrologer/change-password" element={<ProtectedRoute requiredRole="astrologer"><AstrologerChangePassword /></ProtectedRoute>} />
      ...
      <Route path="/user/change-password" element={<ProtectedRoute requiredRole="user"><UserChangePassword /></ProtectedRoute>} />
